...
try {
    // Buat query untuk mengambil jumlah service
    $stmt = $pdo->query('SELECT COUNT(DISTINCT name) AS total_customers FROM customers;
	');
